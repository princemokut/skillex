    ...
    fastify.post('/connections/requests', {
        ...
        handler: async (request, reply) => {
            try {
                ...
                return types_1.connectionResponseSchema.parse(connection);
            }
            catch (error) {
                logger_1.logger.error({ error }, 'Error creating connection request');
    ...
    fastify.post('/connections/:id/accept', {
        ...
        handler: async (request, reply) => {
            try {
                ...
                return types_1.connectionResponseSchema.parse(updatedConnection);
            }
            catch (error) {
                logger_1.logger.error({ error }, 'Error accepting connection request');
                reply.status(500).send({
                    code: 'INTERNAL_ERROR',
    ...
    fastify.post('/connections/:id/decline', {
        ...
        handler: async (request, reply) => {
            try {
                ...
                logger_1.logger.error({ error }, 'Error declining connection request');
                reply.status(500).send({
                    code: 'INTERNAL_ERROR',
    ...
    fastify.get('/connections', {
        ...
        handler: async (request, reply) => {
            try {
                ...
                logger_1.logger.error({ error }, 'Error fetching connections');
                reply.status(500).send({
                    code: 'INTERNAL_ERROR',
